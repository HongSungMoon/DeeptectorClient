#include "../com_example_baeksubuntu_deepstreaming_NDKAdapter.h"
...
JNIEXPORT void JNICALL Java_com_example_baeksubuntu_deepstreaming_NDKAdapter_setDataSource(JNIEnv *env, jclass clazz, jstring _uri){
    uri = (*env)->GetStringUTFChars(env, _uri, NULL);
}

JNIEXPORT jint JNICALL Java_com_example_baeksubuntu_deepstreaming_NDKAdapter_play(JNIEnv * env, jclass clazz, jobject surface)
{
    LOGD("play");
